      ...
      <div className="bg-white dark:bg-forest-900/90 border border-cream-200 dark:border-copper-500/40 rounded-3xl p-6 sm:p-8 shadow-card">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 pt-6">
          ...
          <div className="lg:col-span-5 xl:col-span-4 flex flex-col justify-between space-y-5">
            ...
            {/* LIVE TURNKEY PRICE BREAKDOWN CARD */}
            <div className="p-4 rounded-2xl bg-gradient-to-br from-[#B57731]/15 via-copper-500/10 to-forest-900/10 border-2 border-copper-500/40 shadow-card space-y-3">
              <div className="flex items-center justify-between">
                <div>
                  <span className="text-[10px] font-extrabold uppercase tracking-widest text-[#B57731] dark:text-copper-300 block">
                    Live Turnkey Estimate (Charges)
                  </span>
                  <div className="font-serif text-2xl sm:text-3xl font-black text-forest-950 dark:text-cream-50">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-white/80 dark:bg-forest-950/80 text-[11px] font-bold text-charcoal-700 dark:text-cream-200 border border-cream-200 dark:border-cream-200/10 shadow-sm"
                >
              ...
              {/* Itemized Accordion */}
              {showItemized && (
                <div className="space-y-1.5 pt-2 border-t border-copper-500/20 max-h-[160px] overflow-y-auto text-xs">
                  {pricing.items.map((item, idx) => (
                    <div key={idx} className="flex justify-between items-center text-[11px] text-charcoal-600 dark:text-cream-200/90">
                      <span className="truncate max-w-[210px]">{item.name}</span>
                      <span className="font-mono font-semibold">₹{item.cost.toLocaleString('en-IN')}</span>
                    </div>
                  ))}
                  <div className="flex justify-between items-center text-[11px] text-copper-700 dark:text-copper-300 font-semibold pt-1 border-t border-copper-500/15">
                    <span>Certified Turnkey Labor & Fitting (18%):</span>
                    <span className="font-mono">₹{pricing.laborAndInstallation.toLocaleString('en-IN')}</span>
                  </div>
                </div>
              )}
              ...
              <div className="pt-2 space-y-2.5">
                ...
                <button
                  ...
                  className="w-full py-3.5 px-4 rounded-xl bg-gradient-to-r from-[#B57731] via-[#c68943] to-[#9E6526] hover:brightness-105 text-white font-bold text-xs sm:text-sm tracking-wide shadow-lg shadow-[#B57731]/30 transition-all duration-200 active:scale-[0.98] flex items-center justify-center gap-2 group"
                >
                  <ShoppingBag className="w-4 h-4 transition-transform group-hover:scale-110 shrink-0" />
                  <span className="truncate">Add 3D Package to Quote ({pricing.formattedTotal})</span>
                </button>
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  <Link
                    to="/site-visit"
                    className="py-2.5 px-3 rounded-xl bg-forest-950 dark:bg-cream-100 text-white dark:text-forest-950 hover:bg-forest-900 hover:dark:bg-white text-xs font-bold transition-all text-center flex items-center justify-center gap-1.5 shadow-sm active:scale-95"
                  >
                  ...
                  <button
                    ...
                    className="py-2.5 px-3 rounded-xl bg-white dark:bg-forest-950 text-forest-950 dark:text-cream-100 hover:bg-cream-100 dark:hover:bg-forest-900 border border-cream-200 dark:border-cream-200/20 text-xs font-bold transition-all flex items-center justify-center gap-1.5 shadow-sm active:scale-95"
                  >
                    <FileDown className="w-3.5 h-3.5 text-[#B57731] shrink-0" />
                    <span className="truncate">Download Specs</span>
                  </button>
                </div>
              </div>
            </div>
